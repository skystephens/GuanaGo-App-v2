...
export enum AppRoute {
  ...
  ADMIN_CENTRO_ESTRATEGICO = 'ADMIN_CENTRO_ESTRATEGICO',
  ADMIN_CANVAS_NEGOCIO = 'ADMIN_CANVAS_NEGOCIO',
  ADMIN_DOCS = 'ADMIN_DOCS',
  ADMIN_QUOTES = 'ADMIN_QUOTES',
  ADMIN_CARIBBEAN = 'ADMIN_CARIBBEAN_NIGHT',
  ADMIN_ARTISTAS = 'ADMIN_ARTISTAS',
  ADMIN_CAMPANAS = 'ADMIN_CAMPANAS',
  HOME2 = 'HOME2',
  ADMIN_EDITOR_HOME = 'ADMIN_EDITOR_HOME',
  ADMIN_CRM = 'ADMIN_CRM',
  ADMIN_FINANZAS = 'ADMIN_FINANZAS',
  ADMIN_PAQUETES_INTERNACIONALES = 'ADMIN_PAQUETES_INTERNACIONALES',
  CULTURA_EVENTOS = 'CULTURA_EVENTOS',
  ...
  ADMIN_COPA_DELEGACIONES = 'ADMIN_COPA_DELEGACIONES',
  COPA_PORTAL = 'COPA_PORTAL',
  ADMIN_TRASLADOS_CALC = 'ADMIN_TRASLADOS_CALC',
  COPA_DISPONIBILIDAD_PUBLICA = 'COPA_DISPONIBILIDAD_PUBLICA',
  ADMIN_PRICETRAVEL_CALC = 'ADMIN_PRICETRAVEL_CALC',
  ADMIN_TORRE_COMERCIAL = 'ADMIN_TORRE_COMERCIAL',
  ADMIN_SOCIOS = 'ADMIN_SOCIOS',
  ADMIN_NEGOCIOS_LOCALES = 'ADMIN_NEGOCIOS_LOCALES',
  ...
  ALIADO_DIAGNOSTICO = 'ALIADO_DIAGNOSTICO',
  ADMIN_ALIADOS = 'ADMIN_ALIADOS',
  ADMIN_RED_ALIADOS = 'ADMIN_RED_ALIADOS',
  ...
  ADMIN_TRADUCCION = 'ADMIN_TRADUCCION',
  ADMIN_HERRAMIENTAS = 'ADMIN_HERRAMIENTAS',
  ADMIN_CHATS_ATENCION = 'ADMIN_CHATS_ATENCION',
  // Rutas B2C — Residente
  CONCURSOS = 'CONCURSOS',
  EMBAJADOR = 'EMBAJADOR',
  // Rutas B2C — Turista
